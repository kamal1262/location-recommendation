...
class Sequences:
    ...
    def __init__(self, seq_list, vocab_dict, subsample: float = 0.001, power: float = 0.75):
        ...
        self.META_COLS = ['category_lvl_3', 'brand']
        ...
        logger.info('Location frequency calculated')
        ...
        logger.info('Loc2Id and Id2Loc created and saved')
        
        self.sequences = self.convert_sequence_to_id()
        self.loc_freq = self.convert_loc_freq_to_id()
        logger.info('Convert sequence and location freq to ID')
